<template>
  <div class="pref-editor">
    ...
    <compound>
      <template #head>
        <h6 class="title">{{ $t('preferences.editor.textEditorSettings') }}</h6>
      </template>
      <template #children>
        <range
        ...
        ></font-text-box>
        <text-box
          :description="$t('preferences.editor.maxWidthTextEditor')"
          :notes="$t('preferences.editor.maxWidthTextEditorNotes')"
    ...
    <compound>
      <template #head>
        <h6 class="title">{{ $t('preferences.editor.codeBlockSettings') }}</h6>
      </template>
      <template #children>
        <range
          :description="$t('preferences.editor.fontSize')"
        ...
        <bool
          v-show="false"
          :description="t('preferences.editor.BlockLineNumbers')"
    ...
    <compound>
      <template #head>
        <h6 class="title">{{ $t('preferences.editor.writingBehavior') }}</h6>
      </template>
      <template #children>
        <bool
    ...
    <compound>
      ...
      <template #children>
        ...
        ></cur-select>
        <cur-select
          :description="$t('preferences.editor.lineSeparatorType')"
          :value="endOfLine"
    ...
    <compound>
      ...
      <template #children>
        ...
        ></bool>
        <bool
          :description="$('preferences.editor.hideLinkPopup')"
          :bool="hideLinkPopup"
